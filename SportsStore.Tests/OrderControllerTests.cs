...
public class OrderControllerTests
{
    ...
    {
        // Arrange - create a mock repostory
        Mock<IOrderRepository> mock = new();
        // Arrage - create an empty cart
        Cart cart = new();
        ...
        // Assert - check that the mock method is returning the default view
    ...
    public void Can_Checkout_And_Submit_Order()
    {
        ...
        RedirectToPageResult? result =
            target.Checkout(new()) as RedirectToPageResult;
